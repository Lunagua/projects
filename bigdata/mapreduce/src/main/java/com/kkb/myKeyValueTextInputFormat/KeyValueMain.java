package com.kkb.myKeyValueTextInputFormat;
...
public class KeyValueMain  {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        KeyValueTextInputFormat.addInputPath(job,new Path("file:///D:\\开课吧课程资料\\Hadoop&ZooKeeper课件\\最新版本课件\\hadoop与zookeeper课件资料\\3、第三天\\2、keyValueTextInputFormat\\数据"));
